...
namespace EmployeeApp2
{
    public static class DataSource
    {
        ...
        {
            new Employee {ID=111, CompanyID=111, FirstName="Joseph", LastName="Evans",
                    Salary=new List<double>() {120.2, 356.2, 160.1, 100.99}},
            new Employee {ID=112, CompanyID=111, FirstName="Savannah",
                    LastName="Tower", Salary=new List<double>() {80.9, 90.4, 94.3, 20.3}},
            new Employee {ID=113, CompanyID=112, FirstName="David",
                    LastName="Langley", Salary=new List<double>() {200.1, 320,2, 255,5, 300,9}},
            new Employee {ID=114, CompanyID=111, FirstName="James", LastName="Pardee",
                    Salary=new List<double>() {30.3, 40.5, 35.6, 43.2}}
        };
